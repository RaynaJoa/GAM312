...
APlayerChar::APlayerChar()
{
	...
	// Inital setup of camera component
	...
	//Establishing Resources/Building Arrays
...
void APlayerChar::BeginPlay()
{
	...
	//Calls object widget/updates the widget (starts at 0 when game starts)
	if (objWidget)
	{
...
//Decreased item amount when collecting/uses stamina when collecting 
...
//To decrease hunger and stamina overtime/when collecting items
...
//Collect Items and identify that they are different items
